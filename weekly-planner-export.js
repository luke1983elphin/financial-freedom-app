...
<worksheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships">
  ...
  function buildStartHere(planner) {
    ...
    const rows = [
      ...
      [text("Estimated net pay is based on the income, tax, Medicare levy, STSL compulsory repayments and salary-sacrifice information entered in the Financial Plan. Actual payroll amounts may differ.", STYLE.note), blank(), blank()],
